...
import { MinuteTag, minuteTags } from '@/auth/types';
              ...
              <Combobox.Option
                ...
                className={({ active }) =>
                  classNames(
                    ...
                    active
                      ? 'bg-sky-600 text-white dark:bg-sky-700 dark:text-slate-100'
